...
var canMovePawn = function (toX, toY) {
...
var P1 = DragSource(pp1, pawn1Source, collect)(Pawn1);
...
var PB1 =  DropTarget(pp1, squareTargetP1, collectme)(BoardSquare)
...
try { var eb2t = ($("#eb2").offset().top - 97) % 62.5 == 0
var eb2l = ( $("#eb2").offset().left - ep3offsetxa) % 62.5 == 0
    
if(eb2offsetx != $("#eb2").offset().left && eb2t === true && eb2l === true ||
eb2offsety != $("#eb2").offset().top && eb2t === true && eb2l === true){
...
if(pcheck.toString() != prevc.toString()){
  ...
  if (x === knightX && y === knightY && kkillcount == 0  ) {
     ...
     var b = Xarray.some(function(c) {
return c[0] == x && c[1] == y
    })

if(b === false){
console.log("FSDFSFSFSFSFSDFSDF")
...
squares.push(this.renderSquare(i,PB5));
      ...
      squares.push(this.renderSquare(i,PB1));
